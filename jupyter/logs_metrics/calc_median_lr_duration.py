...
def calculate_median_lr_duration(func_name: str) -> float:
...
def calc_median_lr_duration_OPTIMIZED():
    median_optimized = calculate_median_lr_duration("optimizedFunction")
    print(f"The median of OPTIMIZED function linear-regression duration is: {median_optimized}")

def calc_median_lr_duration_BASELINE():
    median_baseline = calculate_median_lr_duration("baselineFunction")
    print(f"The median of BASELINE function linear-regression duration is: {median_baseline}")   

def return_median_lr_duration_OPTIMIZED():
    return calculate_median_lr_duration("optimizedFunction")

def return_median_lr_duration_BASELINE():
    return calculate_median_lr_duration("baselineFunction")