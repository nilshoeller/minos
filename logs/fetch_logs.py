...
def extract_logs_between_markers(logs):
...
def get_cloud_function_logs(function_name, project_id, limit=50):
    ...
    filtered_logs = extract_logs_between_markers(entries)
    # Print logs and return them as JSON
    print(json.dumps(filtered_logs, indent=2))  # Pretty print JSON
...
if __name__ == "__main__":
    ...
    get_cloud_function_logs(function_name, project_id, limit=10)